#Example for arcgis restapi (PIAPS V KLHK DATA) download by json, and handle limitation of download 1000 object, using simple list collection and data size inspection
